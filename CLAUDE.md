...
- **"מה הכותרת מסתירה?" (פענוח קליקבייט דרך Clickbyter):** כפתור
  ...
  מבטיח שה-AI יפיק תשובה טובה - רק שאין חסימת אנטי-בוט). וה-Worker עצמו
  מוצהר (ב-PROJECT_STATE.md של clickbyter) כבלי rate limiting - שווה
  לזכור אם קצב השימוש עולה.
