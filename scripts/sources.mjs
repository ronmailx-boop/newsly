...
export const sources = [
  ...
  },
  {
    ...
    name: 'N12',
    type: 'rss',
    // n12.co.il עצמו חסום ע"י Radware (ראו ההיסטוריה למטה) - אבל N12
    // הוא בפועל "מאקו חדשות" שעבר מיתוג מחדש, והתוכן העיתונאי עדיין
    // מוגש דרך תשתית mako.co.il, שם ה-RSS פתוח ולא חסום. אומת בפועל
    // (2026-09-14): XML תקין, כותרות/תאריכים כרונולוגיים ועדכניים,
    // חדשות כלליות מהארץ (לא ניוז-לטר נישתי).
    url: 'https://www.mako.co.il/rss/news-israel.xml',
  },
];
